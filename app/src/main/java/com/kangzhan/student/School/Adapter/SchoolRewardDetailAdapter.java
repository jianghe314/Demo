...
public class SchoolRewardDetailAdapter extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<ExpandReward> parentData;
    private ArrayList<ArrayList<ExpandChild>> childrenData;
    public SchoolRewardDetailAdapter(Context context,ArrayList<ExpandReward> parent,ArrayList<ArrayList<ExpandChild>> children) {
