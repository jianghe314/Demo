...
public class AllocationTeacherActivity extends BaseActivity {
    private Gson gson;
    private int mpage=1;
    private PullRecyclerView recycler;
    private EduStMAlloTeaAdapter adapter;
            ...
            switch (msg.what){
                ...
                case 2222:
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            recycler.stopRefresh();
                            adapter.notifyDataSetChanged();
                            mToast.showText(AllocationTeacherActivity.this,mmsg);
                        }
                    });
                    break;
                case 3333:
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            showProgress.showProgress(AllocationTeacherActivity.this,"分配中...");
                        }
                    });
                    break;
                case 4444:
                ...
                case 9999:
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            showMessage.showMsg(AllocationTeacherActivity.this,"网络连接异常，请检查网络连接");
                        }
                    });
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allocation_teacher);
    ...
    private void initView() {
        adapter=new EduStMAlloTeaAdapter(AllocationTeacherActivity.this,R.layout.item_school_edu_stum_alloc,data);
            ...
            public void onLoadMore() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        params.add("type");
                        params.add("page");
                        values.add(school.schoolKey(AllocationTeacherActivity.this));
                        values.add("2");
                        values.add(mpage+"");
            ...
            case R.id.sure:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        sendRequset("POST",2,school.EduAllocaTeacher(),params,values);
                    }
                }).start();
                break;
            default:
