...
/**
 * Created by kangzhan011 on 2017/3/27.
 */
...
public class StarBar extends View {
    ...
    private boolean starEnable;         //星星是否可以点击
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        this.starSize = (int) mTypedArray.getDimension(R.styleable.RatingBar_starSize, 5);
        ...
        //
        this.starEnable=mTypedArray.getBoolean(R.styleable.RatingBar_starEnable,false);     //默认不可点击
