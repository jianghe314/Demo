...
import com.kangzhan.student.Teacher.Adapter.TeacherBookingTrain2Adapter;
...
public class BookingTrain2 extends Fragment {
    ...
    private View view;
    private String mmsg;
    private TeacherBookingTrain2Adapter adapter;
    private ArrayList<TeacherBookingTrain1> mdata2=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(view==null){
            view=inflater.inflate(R.layout.teacher_booking_train2,container,false);
    ...
    private void initView(View v) {
        person= (TextView) v.findViewById(R.id.teacher_booking_train2_sum);
        //hour= (TextView) v.findViewById(R.id.teacher_booking_train2_hours);
        adapter=new TeacherBookingTrain2Adapter(getContext(),R.layout.item_teacher_booking2,mdata2,getActivity());
        recycler= (PullRecyclerView) v.findViewById(R.id.teacher_booking_train2_recycler);
    ...
    private void sendRequest() {
        ...
        requestQueue.add(1, request, new OnResponseListener<JSONObject>() {
            ...
            public void onSucceed(int what, Response<JSONObject> response) {
                mLog.i("response2","->"+response.get().toString());
                try {
