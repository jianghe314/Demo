...
public class MyStudentFragment2 extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(view==null){
            view=inflater.inflate(R.layout.item_teacher_mystudent2,container,false);
    ...
    private void initView(View  v) {
        sum= (TextView) v.findViewById(R.id.teacher_myStudent_sum2);
        recycler= (PullRecyclerView) v.findViewById(R.id.teacher_myStudent_l2);
