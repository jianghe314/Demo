...
import com.kangzhan.student.CompayManage.Adapter.SelfRegSchoAdapter;
...
public class SchoolManageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Gson gson;
    private SelfRegSchoAdapter adapter;
    private String mmsg;
    private int mpage=1;
    private ArrayList<String> params=new ArrayList<>();
    private ArrayList<String> values=new ArrayList<>();
    private ArrayList<SelfRegSchoM> mdata=new ArrayList<>();
            ...
            switch (msg.what){
                ...
                case 3333:
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            showProgress.showProgress(SchoolManageActivity.this,"删除中...");
                        }
                    });
                    break;
                case 4444:
                ...
                case 9999:
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            recycler.stopRefresh();
                            showMessage.showMsg(SchoolManageActivity.this,"网络连接异常，请检查网络连接");
                        }
                    });
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar= (Toolbar) findViewById(R.id.compay_self_regist_school_toolbar);
    ...
    private void initView() {
        startT= (TextView) findViewById(R.id.self_regist_school_setStartT);
        endT= (TextView) findViewById(R.id.self_regist_school_setEndT);
        doSearch= (TextView) findViewById(R.id.self_regist_school_Tosearch);
        searchContent= (EditText) findViewById(R.id.self_regist_school_search_content);
        recycler= (PullRecyclerView) findViewById(R.id.self_regist_school_recycler);
    ...
    private void initData() {
        adapter=new SelfRegSchoAdapter(SchoolManageActivity.this,R.layout.item_compay_self_regist,mdata);
            ...
            public void onLoadMore() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        values.add(mpage+"");
                        values.add("3");
                        sendRequest("GET",CompayInterface.SelfRegStu(),3,params,values);
                    }
                }).start();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.self_regist_school_setStartT:
                com.kangzhan.student.utils.picker.DatePicker picker=new com.kangzhan.student.utils.picker.DatePicker(SchoolManageActivity.this);
                ...
                picker.show();
                break;
            case R.id.self_regist_school_setEndT:
                com.kangzhan.student.utils.picker.DatePicker picker1=new com.kangzhan.student.utils.picker.DatePicker(SchoolManageActivity.this);
                ...
                picker1.show();
                break;
            case R.id.self_regist_school_Tosearch:
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        new Thread(new Runnable() {
            ...
            case R.id.item_compay_self_regist_menu3:
                popupMenu.dismiss();
                final Dialog dialog=new Dialog(SchoolManageActivity.this);
                        ...
                        if(object.getString("code").equals("200")){
                            ...
                            if(array.length()>0){
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    SelfRegSchoM m=gson.fromJson(array.getJSONObject(i).toString(),SelfRegSchoM.class);
                                    mdata.add(m);
                                }
