...
public class CompayStuManageActivity extends BaseActivity implements View.OnClickListener{
    ...
    private Gson gson;
    private InfoStuManageAdapter adapter;
    private ArrayList<String> params=new ArrayList<>();
    private ArrayList<String> values=new ArrayList<>();
    private ArrayList<InfoStuManage> mdata=new ArrayList<>();
    private String mmsg;
    private int mpage=1;
            ...
            switch (msg.what){
                ...
                case 3333:
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            showProgress.showProgress(CompayStuManageActivity.this,"删除中...");
                        }
                    });
                    break;
                case 4444:
                ...
                case 9999:
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            recycler.stopRefresh();
                            showMessage.showMsg(CompayStuManageActivity.this,"网络连接异常，请检查网络连接");
                        }
                    });
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compay_stu_manage);
        Toolbar toolbar= (Toolbar) findViewById(R.id.compay_stuManage_toolbar);
    ...
    private void initView() {
        startT= (TextView) findViewById(R.id.compay_stuM_setStartT);
        endT= (TextView) findViewById(R.id.compay_stuM_setEndT);
        dosearch= (TextView) findViewById(R.id.compay_info_search_content_Tosearch);
        searchContent= (EditText) findViewById(R.id.compay_info_search_content);
        recycler= (PullRecyclerView) findViewById(R.id.compay_stuM_recycler);
    ...
    private void initData() {
        adapter=new InfoStuManageAdapter(CompayStuManageActivity.this,R.layout.item_compay_info_stum_recycler,mdata);
            ...
            public void onPullRefresh() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        sendRequest("GET",CompayInterface.InfoStuManage(),1,params,values);
                    }
                }).start();
            }
            ...
            public void onLoadMore() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        values.add(CompayInterface.CompayKey(getApplicationContext()));
                        values.add(mpage+"");
                        sendRequest("GET",CompayInterface.InfoStuManage(),3,params,values);
                    }
                }).start();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.compay_stuM_setStartT:
                com.kangzhan.student.utils.picker.DatePicker picker=new com.kangzhan.student.utils.picker.DatePicker(CompayStuManageActivity.this);
                ...
                picker.show();
                break;
            case R.id.compay_stuM_setEndT:
                com.kangzhan.student.utils.picker.DatePicker picker1=new com.kangzhan.student.utils.picker.DatePicker(CompayStuManageActivity.this);
                ...
                picker1.show();
                break;
            case R.id.compay_info_search_content_Tosearch:
                //搜索
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                ...
                break;
            /*
            case R.id.item_compay_stu_manage_menu1:
                //发送消息
                popupMenu.dismiss();
                isShow=false;
                break;
                ...
                if(builder.toString().length()>0){
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            sendRequest("POST",CompayInterface.InfoStuDele(),2,params,values);
                        }
                    }).start();
                }else {
                        ...
                        if(object.getString("code").equals("200")){
                            ...
                            if(array.length()>0){
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    InfoStuManage info=gson.fromJson(array.getJSONObject(i).toString(),InfoStuManage.class);
                                    mdata.add(info);
                                }
