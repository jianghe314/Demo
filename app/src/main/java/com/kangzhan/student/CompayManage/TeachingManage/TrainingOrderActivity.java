...
public class TrainingOrderActivity extends BaseActivity implements View.OnClickListener {
    //已完成，未完成没有给字段
    ...
    private Gson gson;
    private TrainingOrderAdapter adapter;
    private ArrayList<String> params=new ArrayList<>();
    private ArrayList<String> values=new ArrayList<>();
    private ArrayList<CompayTrainingOrder> mdata=new ArrayList<>();
    private String mmsg;
    private int mpage=1;
            ...
            switch (msg.what){
                ...
                case 9999:
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            recycler.stopRefresh();
                            showMessage.showMsg(TrainingOrderActivity.this,"网络连接异常，请检查网络连接");
                        }
                    });
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar= (Toolbar) findViewById(R.id.training_order_toolbar);
    ...
    private void initView() {
        startT= (TextView) findViewById(R.id.training_order_setStartT);
        endT= (TextView) findViewById(R.id.training_order_setEndT);
        doSearch= (TextView) findViewById(R.id.training_order_Tosearch);
        searchContent= (EditText) findViewById(R.id.training_order_search_content);
        recycler= (PullRecyclerView) findViewById(R.id.training_order_recycler);
    ...
    private void initData() {
        adapter=new TrainingOrderAdapter(TrainingOrderActivity.this,R.layout.item_compay_teaching_training_recycler,mdata);
            ...
            public void onPullRefresh() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        values.add("2");
                        sendRequest("GET",CompayInterface.TrainingOrder(),1,params,values);
                    }
                }).start();
            }
            ...
            public void onLoadMore() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        values.add("2");
                        values.add(mpage+"");
                        sendRequest("GET",CompayInterface.TrainingOrder(),3,params,values);
                    }
                }).start();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.training_order_setStartT:
                com.kangzhan.student.utils.picker.DatePicker picker=new com.kangzhan.student.utils.picker.DatePicker(TrainingOrderActivity.this);
                ...
                picker.show();
                break;
            case R.id.training_order_setEndT:
                com.kangzhan.student.utils.picker.DatePicker picker1=new com.kangzhan.student.utils.picker.DatePicker(TrainingOrderActivity.this);
                ...
                picker1.show();
                break;
            case R.id.training_order_Tosearch:
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        params.clear();
                        ...
                        if(object.getString("code").equals("200")){
                            ...
                            if(array.length()>0){
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    CompayTrainingOrder order=gson.fromJson(array.getJSONObject(i).toString(),CompayTrainingOrder.class);
                                    mdata.add(order);
                                }
