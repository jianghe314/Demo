...
public class AccountCheckingActivity extends BaseActivity implements View.OnClickListener{
    private TextView address,doSearch;
            ...
            switch (msg.what){
                ...
                case 3333:
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            showProgress.showProgress(AccountCheckingActivity.this,"删除中...");
                        }
                    });
                    break;
                case 4444:
                ...
                case 9999:
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            recycler.stopRefresh();
                            showMessage.showMsg(AccountCheckingActivity.this,"网络连接异常，请检查网络连接");
                        }
                    });
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar= (Toolbar) findViewById(R.id.account_checking_toolbar);
    ...
    private void initView() {
        address= (TextView) findViewById(R.id.account_checking_search_content);
        doSearch= (TextView) findViewById(R.id.account_checking_Tosearch);
        recycler= (PullRecyclerView) findViewById(R.id.account_checking_recycler);
        btn= (Button) findViewById(R.id.account_checking_btn);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.account_checking_search_content:
                ...
                break;
            case R.id.account_checking_Tosearch:
                initData();
                break;
            case R.id.account_checking_btn:
                String id="";
                ...
                if(id.length()>0){
                    Intent detail=new Intent(this,AccountCheckingInqueryActivity.class);
    ...
    private void initData() {
        adapter=new AccountSchoolListAdapter(AccountCheckingActivity.this,R.layout.item_compay_account_school_recycler,mdata);
            ...
            public void onPullRefresh() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        params.add("city_id");
                        values.add(CompayInterface.CompayKey(AccountCheckingActivity.this));
                        values.add("2");
                        values.add(mprovince);
                        values.add(mcity);
                        sendRequest("GET",CompayInterface.AccountSchoolList(),1,params,values);
                    }
                }).start();
            }
