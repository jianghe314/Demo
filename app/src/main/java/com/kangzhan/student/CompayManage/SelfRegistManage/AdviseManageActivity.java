...
import com.kangzhan.student.CompayManage.Adapter.AdviseManageAdapter;
...
public class AdviseManageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Gson gson;
    private ArrayList<AdviseManage> mdata=new ArrayList<>();
    private ArrayList<String> params=new ArrayList<>();
    private ArrayList<String> values=new ArrayList<>();
    private AdviseManageAdapter adapter;
    private int mpage=1;
            ...
            switch (msg.what){
                ...
                case 3333:
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            showProgress.showProgress(AdviseManageActivity.this,"删除中...");
                        }
                    });
                    break;
                case 4444:
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            sendRequest("GET",CompayInterface.AdviseManage(),1,params,values);
                        }
                    }).start();
                    runOnUiThread(new Runnable() {
                        @Override
                ...
                case 9999:
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            recycler.stopRefresh();
                            showMessage.showMsg(AdviseManageActivity.this,"网络连接异常，请检查网络连接");
                        }
                    });
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advise_manage);
        Toolbar toolbar= (Toolbar) findViewById(R.id.compay_self_regist_advise_toolbar);
    ...
    private void initView() {
        startT= (TextView) findViewById(R.id.self_regist_advise_setStartT);
        endT= (TextView) findViewById(R.id.self_regist_advise_setEndT);
        doSearch= (TextView) findViewById(R.id.self_regist_advise_Tosearch);
        searchContent= (EditText) findViewById(R.id.self_regist_advise_search_content);
        recycler= (PullRecyclerView) findViewById(R.id.self_regist_advise_recycler);
    ...
    private void initData() {
        adapter=new AdviseManageAdapter(AdviseManageActivity.this,R.layout.item_compay_self_regist_advise_list,mdata);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.self_regist_advise_setStartT:
                com.kangzhan.student.utils.picker.DatePicker picker=new com.kangzhan.student.utils.picker.DatePicker(AdviseManageActivity.this);
                ...
                picker.show();
                break;
            case R.id.self_regist_advise_setEndT:
                com.kangzhan.student.utils.picker.DatePicker picker1=new com.kangzhan.student.utils.picker.DatePicker(AdviseManageActivity.this);
                ...
                picker1.show();
                break;
            case R.id.self_regist_advise_Tosearch:
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        new Thread(new Runnable() {
                ...
                break;
            case R.id.item_compay_self_regist_advise_menu2:
                //删除
                popupMenu.dismiss();
                ...
                if(builder.toString().length()>0){
                    ...
                    sendRequest("GET",CompayInterface.AdviseDelet(),4,params,values);
                }else {
                        ...
                        if(object.getString("code").equals("200")){
                            ...
                            if(array.length()>0){
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    AdviseManage m=gson.fromJson(array.getJSONObject(i).toString(),AdviseManage.class);
                                    mdata.add(m);
                                }
    ...
    private void addMenu() {
        View root= LayoutInflater.from(this).inflate(R.layout.item_compay_self_regist_advise_menu,null);
        menu2= (LinearLayout) root.findViewById(R.id.item_compay_self_regist_advise_menu2);
        ...
        popupMenu.showAtLocation(getLayoutInflater().inflate(R.layout.activity_advise_manage,null), Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL,0,0);
    }
