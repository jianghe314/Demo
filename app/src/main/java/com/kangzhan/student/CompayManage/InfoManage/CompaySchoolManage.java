...
public class CompaySchoolManage extends BaseActivity implements View.OnClickListener {
    ...
    private TextView startT,endT,doseacher;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar= (Toolbar) findViewById(R.id.compay_schoolManage_toolbar);
    ...
    private void initView() {
        startT= (TextView) findViewById(R.id.compay_schoolM_setStartT);
        endT= (TextView) findViewById(R.id.compay_schoolM_setEndT);
        doseacher= (TextView) findViewById(R.id.compay_info_school_search_content_Tosearch);
        searchContent= (EditText) findViewById(R.id.compay_info_school_search_content);
        recycler= (PullRecyclerView) findViewById(R.id.compay_schoolM_recycler);
        ...
        doseacher.setOnClickListener(this);
    }

    private void initData() {
        adapter=new InfoSchoolManageAdapter(CompaySchoolManage.this,R.layout.item_compay_info_schoolm_recycler,mdata);
            ...
            public void onPullRefresh() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        sendRequest("GET",CompayInterface.InfoSchoolManage(),1,params,values);
                    }
                }).start();
            }
            ...
            public void onLoadMore() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        params.add("key");
                        params.add("page");
                        values.add(CompayInterface.CompayKey(CompaySchoolManage.this));
                        values.add(mpage+"");
                        sendRequest("GET",CompayInterface.InfoSchoolManage(),3,params,values);
                    }
                }).start();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.compay_schoolM_setStartT:
                com.kangzhan.student.utils.picker.DatePicker picker=new com.kangzhan.student.utils.picker.DatePicker(CompaySchoolManage.this);
                ...
                picker.show();
                break;
            case R.id.compay_schoolM_setEndT:
                com.kangzhan.student.utils.picker.DatePicker picker1=new com.kangzhan.student.utils.picker.DatePicker(CompaySchoolManage.this);
                ...
                picker1.show();
                break;
            case R.id.compay_info_school_search_content_Tosearch:
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        params.clear();
                ...
                break;
            case R.id.item_compay_school_manage_menu1:
                popupMenu.dismiss();
                isShow=false;
                ...
                if(builder.toString().length()>0){
                    Intent alloca=new Intent(this, ChoiceClerkActivity.class);
                    alloca.putExtra("Id",builder.toString().substring(0,builder.toString().length()-1));
                    alloca.putExtra("who","school");
                    startActivity(alloca);
                    finish();
                }else {
                ...
                break;
            /*
            case R.id.item_compay_school_manage_menu2:
                popupMenu.dismiss();
                isShow=false;
                break;
            case R.id.item_compay_school_manage_menu3:
                popupMenu.dismiss();
                isShow=false;
                //没有删除接口
                break;
                        ...
                        if(object.getString("code").equals("200")){
                            ...
                            if(array.length()>0){
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    InfoSchoolManage order=gson.fromJson(array.getJSONObject(i).toString(),InfoSchoolManage.class);
                                    mdata.add(order);
                                }
    ...
    private void addMenu() {
        //实现 PopupWindow
        View root= LayoutInflater.from(this).inflate(R.layout.item_compay_school_manage_menu,null);
        menu1= (LinearLayout) root.findViewById(R.id.item_compay_school_manage_menu1);
        //menu2= (LinearLayout) root.findViewById(R.id.item_compay_school_manage_menu2);
        //menu3= (LinearLayout) root.findViewById(R.id.item_compay_school_manage_menu3);
