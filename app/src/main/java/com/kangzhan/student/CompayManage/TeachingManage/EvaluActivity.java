...
public class EvaluActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Gson gson;
    private EvaluRecordAdapter adapter;
    private ArrayList<String> params=new ArrayList<>();
    private ArrayList<String> values=new ArrayList<>();
    private ArrayList<EvaluRecord> mdata=new ArrayList<>();
    private String mmsg;
    private int mpage=1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comnpay_evalu);
        Toolbar toolbar= (Toolbar) findViewById(R.id.compay_teaching_evalu_toolbar);
    ...
    private void initView() {
        startT= (TextView) findViewById(R.id.compay_teaching_evalu_setStartT);
        endT= (TextView) findViewById(R.id.compay_teaching_evalu_setEndT);
        doSearch= (TextView) findViewById(R.id.compay_teaching_evalu_Tosearch);
        searchContent= (EditText) findViewById(R.id.compay_teaching_evalu_search_content);
        recycler= (PullRecyclerView) findViewById(R.id.compay_teaching_evalu_recycler);
    ...
    private void initData() {
        adapter=new EvaluRecordAdapter(EvaluActivity.this,R.layout.item_compay_teaching_evalu_recycler,mdata);
            ...
            public void onPullRefresh() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        sendRequest("GET",CompayInterface.EvalueRecord(),1,params,values);
                    }
                }).start();
            }
            ...
            public void onLoadMore() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        values.add(CompayInterface.CompayKey(getApplicationContext()));
                        values.add(mpage+"");
                        sendRequest("GET",CompayInterface.EvalueRecord(),3,params,values);
                    }
                }).start();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.compay_teaching_evalu_setStartT:
                com.kangzhan.student.utils.picker.DatePicker picker=new com.kangzhan.student.utils.picker.DatePicker(EvaluActivity.this);
                ...
                picker.show();
                break;
            case R.id.compay_teaching_evalu_setEndT:
                com.kangzhan.student.utils.picker.DatePicker picker1=new com.kangzhan.student.utils.picker.DatePicker(EvaluActivity.this);
                ...
                picker1.show();
                break;
            case R.id.compay_teaching_evalu_Tosearch:
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        params.clear();
                        ...
                        if(object.getString("code").equals("200")){
                            ...
                            if(array.length()>0){
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    EvaluRecord record=gson.fromJson(array.getJSONObject(i).toString(),EvaluRecord.class);
                                    mdata.add(record);
                                }
