...
public class TeaFollowUp {
    private String id;
    private String inten_coach_id;
    ...
    public String getInten_coach_id() {
        return inten_coach_id;
    }

    public void setInten_coach_id(String inten_coach_id) {
        this.inten_coach_id = inten_coach_id;
    }
