...
public class NewsBusiness extends LazyFragment {
    ...
    protected int setContentView() {
        return R.layout.recommend_news_3;
    }

    @Override
    protected void lazyLoad() {
        gson=new Gson();
        recyclerView=findViewById(R.id.recommend_news_Business);
        adapter=new RecommendNewsAdapter(getContext(),R.layout.item_recommend_news,mdata,"32");
