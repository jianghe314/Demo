...
public class NewsAll extends LazyFragment {
    ...
    protected int setContentView() {
        return R.layout.recommend_news_1;
    }

    @Override
    protected void lazyLoad() {
        gson=new Gson();
        recyclerView=findViewById(R.id.recommend_news_all);
        adapter=new RecommendNewsAdapter(getContext(),R.layout.item_recommend_news,mdata,"17");
