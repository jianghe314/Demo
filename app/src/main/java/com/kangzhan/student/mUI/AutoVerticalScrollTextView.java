...
public class AutoVerticalScrollTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    private TextItemOnClick itemOnClick;
    ...
    public void TextViewItemOnClick(TextItemOnClick itemOnClick){
    ...
    public interface TextItemOnClick{
        void textItemOnClick();
    }
